...
type:'line',//グラフのタイプ
data:{//グラフのデータ
  labels:["2021.06","2021.12","2022.06","2022.12"],//データの名前
  datasets:[{
      label:"参加人数の変化",//グラフのタイトル
      borderColor: "rgba(255,136,130,1)",//グラフの線の色
      backgroundColor:"rgba(255,0,0,0.1)",//グラフの背景色
      data:["260","278","415","430"]//横列に並ぶデータ
    }]
},
options:{//グラフのオプション
  legend:{
